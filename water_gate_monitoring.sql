...
('CMD00002', 'M001', '2023-11-26 06:47:04'),
('CMD00003', 'M001', '2023-11-26 06:55:27');
...
('CMD00002', '1', 'WG11202', 'WG11208', 0.23),
('CMD00002', '2', 'WG11105', 'WG11202', 0.04),
('CMD00003', '1', 'WG11205', 'WG11206', 0.3),
('CMD00003', '2', 'WG11205', 'WG11214', 0.01),
('CMD00003', '3', 'WG11205', 'WG11216', 0.9);
...
('CMD00002', '1', 'เปิดตอน 02:00 จนลดไป 0.23 ม.รทก', NULL, NULL, NULL, 0),
('CMD00002', '2', 'เปิดตอน 02:00 ', NULL, NULL, NULL, 0),
('CMD00003', '1', '8:00 เปิดเลย', NULL, NULL, NULL, 0),
('CMD00003', '2', '8.30 รอคำสั่งก่อนห้าทำสำเร็จก่อน', NULL, NULL, NULL, 0),
('CMD00003', '3', 'รอคำสั่งก่อนหน้า', NULL, NULL, NULL, 0);
...
(14, 'E001', 'WG11202', 2.11, 2.98, 12, '2023-11-05 17:41:52'),
...
(25, 'E009', 'WG11202', 2.1, 2.91, 11.9, '2023-11-06 17:37:00'),
(26, 'E008', 'WG11202', 2.14, 2.89, 12, '2023-11-07 17:41:52'),
(27, 'E010', 'WG11203', 1.6, 2.25, 15, '2023-11-06 17:32:24'),
(28, 'E010', 'WG11203', 1.62, 2.19, 18, '2023-11-07 17:41:52'),
(29, 'E008', 'WG11204', 2.05, 2, 0.1, '2023-11-06 17:41:52'),
(30, 'E008', 'WG11204', 2.09, 2.04, 0.1, '2023-11-07 17:41:52'),
(31, 'E009', 'WG11205', 1.62, 1.61, 9.85, '2023-11-06 17:41:52'),
(32, 'E007', 'WG11205', 1.61, 1.6, 9.85, '2023-11-07 17:41:52'),
...
('WG11202', 'ปตร.สน.จุฬาลงกรณ์', 2, 'คลองรังสิตประยูรศักด', 1.3),
('WG11203', 'ปตร.สน.เสาวภาผ่องศรี', 1, 'ปตร.สน.สมบูรณ์', 1.5),
('WG11204', 'ปตร.สน.สมบูรณ์', 1, 'คลองหกวาสายล่าง', 1.3),
('WG11205', 'ปตร.หกวา', 2, 'คลอง13', 1.3),
('WG11206', 'ปตร.บึงฝรั่ง', 1, 'คลองบึงฝรั่ง', 1.3),
('WG11207', 'ปตร.ปลายคลอง 13', 1, 'คลอง13', 1.3),
('WG11208', 'ปตร.เปรมใต้', 0, 'คลองเปรมประชากร', 1.7),
('WG11209', 'ปตร.ปลายคลอง 6', 0, 'คลอง6', 3.3),
('WG11210', 'ปตร.กลางคลอง 8', 0, 'คลอง8', 2.3),
('WG11211', 'ปตร.กลางคลอง 9', 0, 'คลอง9', 2.3),
('WG11212', 'ปตร.กลางคลอง 10', 0, 'คลอง10', 2.3),
('WG11213', 'ปตร.ปลายคลอง 14', 0, 'คลอง14', 2.3),
('WG11214', 'ปตร.ปลายคลอง 15', 0, 'คลอง15', 2.3),
('WG11215', 'ปตร.ปลายคลอง 16', 0, 'คลอง16', 2.3),
('WG11216', 'ปตร.ปลายคลอง 17', 0, 'คลอง17', 2.3);
